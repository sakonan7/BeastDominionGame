...
public class ArmadilloCameraScriot : MonoBehaviour
{
    public GameObject target;
    public float turnSpeed = .2f;
    public GameObject armadilloCamera;
    ...
    void Update()
    {
        ...
        armadilloCamera.transform.localPosition = new Vector3(0f, cameraDistance, -2f * cameraDistance);
    }
